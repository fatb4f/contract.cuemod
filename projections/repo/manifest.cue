...
manifest: repocontract.#RepoLayout & {
	...
	surfaces: [
		...
		{path: "generated/", kind: "directory", role: "generated", lifecycle: "generated", authority: "derived", generated: true, owner: "contracts/agent-context-resolver", description: "Generated resolver projections and lifecycle outputs.", validatesWith: ["cue vet ./contracts", "./test/check.sh"]},
		{path: "seeds/", kind: "directory", role: "fixture", lifecycle: "test-fixture", authority: "non-authority", generated: false, owner: "contracts/validation", description: "Imported seed bundles that validate independently.", validatesWith: ["./seeds/contract-cuemod/agent-context-resolver/scripts/validate.sh"]},
