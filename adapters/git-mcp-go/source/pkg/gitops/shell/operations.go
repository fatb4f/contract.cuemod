...
func (s *ShellGitOperations) AmendCommit(repoPath string, message string, noEdit bool) (string, error) {
...
func (s *ShellGitOperations) CherryPick(repoPath string, revision string) (string, error) {
...
func (s *ShellGitOperations) RevertCommit(repoPath string, revision string, noCommit bool) (string, error) {
	args := []string{"revert"}
	if noCommit {
...
func (s *ShellGitOperations) ListWorktrees(repoPath string) (string, error) {
	return gitops.RunGitCommand(repoPath, "worktree", "list", "--porcelain")
}

// AddWorktree creates a linked worktree.
func (s *ShellGitOperations) AddWorktree(repoPath string, worktreePath string, branch string, commit string, detach bool) (string, error) {
...
func (s *ShellGitOperations) RemoveWorktree(repoPath string, worktreePath string, force bool) (string, error) {
...
func (s *ShellGitOperations) PruneWorktrees(repoPath string) (string, error) {
